...
//item1:count1:sample1#item2:count2:sample2_Ess#sample_list
	...
	for(int i=0;i<frequent_items.length;i++){
		...
		context.write(new Text(tmp.toString()), new Text(frequent_items[i]+"#"+line[1]));
//	Key : item1:count1#		Value : item2:count2#Ess#sample_list
	}
